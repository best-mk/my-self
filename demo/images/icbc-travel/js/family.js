...
//接口域名
//var hostsUrl = 'http://192.168.1.109:8080/riskeys_neighbor_communicate';
var hostsUrl = 'http://114.55.58.53:8086';
//微信分享
var shareUrl = location.origin+'/activity/icbc-travel/index.html';
...
$(function(){
    ...
    $('.draw-insurance-btn').on('click', function(event){
        ...
        if(birth.age<18||birth.age>65){
            showMaskEditCom({
                text: '<p class="ed_mask">限18周岁至65周岁的用户领取</p>',
                duration: 1500
            });
            return false;
        }
